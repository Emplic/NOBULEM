...
if not isfolder("nobulemhub") then
	makefolder("nobulemhub")
end

if not isfolder("nobulemhub/Assets") then
	makefolder("nobulemhub/Assets")
end

if not isfolder("nobulemhub/Configs") then
	makefolder("nobulemhub/Configs")
end

if not isfolder("nobulemhub/Themes") then
	makefolder("nobulemhub/Themes")
end
...
local Library do
	...
	Library = {
		...
		Folders = {
			Directory = "nobulemhub",
			Configs = "nobulemhub/Configs",
			Assets = "nobulemhub/Assets",
			Themes = "nobulemhub/Themes"
		},
	...
	Library.Window = function(self, Properties)
		...
		local Window = {
			Name = Properties.Name or Properties.name or "nobulemhub",
